...
class FastHTTPRequestHandler(SimpleHTTPRequestHandler):
    def end_headers(self):
        # Enviar headers otimizados para máxima velocidade de resposta
        self.send_header('X-Content-Type-Options', 'nosniff')
        self.send_header('Access-Control-Allow-Origin', '*')
        
        # Cache imutável para mídias e imagens locais, no-cache para index.html (atualizações instantâneas)
    ...
    # Otimizar logs para não travar o loop de I/O
